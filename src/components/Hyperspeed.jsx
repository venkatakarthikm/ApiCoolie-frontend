...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS, onWebGLFailed }) => {
  ...
  return (
    <div className="w-full h-full relative" ref={hyperspeed}>
      {webglFailed && (
        <div className="absolute inset-0 bg-black overflow-hidden pointer-events-none w-full h-full">
          <div className="absolute top-[-50%] left-[-50%] w-[200%] h-[200%] bg-gradient-to-tr from-emerald-500/10 via-pink-500/10 to-blue-500/10 animate-spin" style={{ animationDuration: '30s' }} />
