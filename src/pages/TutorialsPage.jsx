...
import { BookOpen, Terminal, ShieldAlert, Cpu, Check, Copy, ArrowRight, Slack, Database, Lock } from 'lucide-react';
...
function signPayload(payloadObject, sharedHmacSecret) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-8 animate-scale text-xs md:text-sm">
      <Helmet>
        <title>Developer Tutorials | Api Coolie</title>
        <meta name="description" content="Step-by-step tutorials to get the most out of Api Coolie. Set up slack monitoring, database routines, and HMAC webhook signature checks." />
      </Helmet>
